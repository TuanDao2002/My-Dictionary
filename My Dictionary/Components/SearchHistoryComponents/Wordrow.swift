    ...
    var body: some View {
        HStack{
            Image(systemName: isFavorite ? "star.fill" : "star")
                ...
                .font(.system(.title2))
                .disabled(title == "Word not found" || title == "Loading..." || title == "Please enter a word" || !userVM.isLogin() ? true : false)
                .opacity(title == "Word not found" || title == "Loading..." || title == "Please enter a word" || !userVM.isLogin() ? 0 : 1)
                .padding(.horizontal)
